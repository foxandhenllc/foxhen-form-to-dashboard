# Contributing to Form to Dashboard

Form to Dashboard is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A form schema and dashboard builder for field mapping, sample submissions, KPI tracking, and CSV import/export.
